                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="row">
                                    ...
                                    {/* <div className="col-4">
                                        <Image className='rounded' src={PickUp_BSB} alt="" height="130px" layout='responsive' />
                                        <Image className='rounded mt-3' src={Jumia_Prime} alt="" height="130px" layout='responsive' />
                                        <div className="row">
                                        </div>
                                    </div> */}
                                </div>
