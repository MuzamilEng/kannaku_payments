            ...
            <div className={`main-wrapper ${menu ? "slide-nav" : ""}`}>
                ...
                <div id="calendar-events" className="mb-3">
                  ...
                  <Link href="/billing/ledger">
                    <a>
                      <div className="calendar-events" style={{ backgroundColor: "#14BEF0", color: "white" }}>Ledger</div>
                    </a>
                  </Link>
                </div>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="row mt-2">
                                            ...
                                            <div className="col-8">
                                                <div className="row">
                                                    <div className="col-3">
                                                        <button className='btn border'><small>Add Payment</small></button>
                                                    </div>  
                                                    <div className="col-3">
                                                        <button className='btn border'><small>Add Invoices</small></button>
                                                    </div>
                                                    <div className="col-2">
                                                        <button className='btn border'>Print</button>
                                                    </div>
                                                    <div className="col-4">
                                                        <button className='btn' style={{ backgroundColor: "#14BEF0", color: "white" }}> <small>Send Payment Reminder</small> </button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
