            ...
            <div className={`main-wrapper ${menu ? 'slide-nav' : ''}`}>
                            ...
                            <div className="row align-items-center">
                                <div className="col">
                                    ...
                                    <ul className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item active">EMR</li>
                ...
                <div id="calendar-events" className="mb-3">
                  ...
                  <Link href="/emr/prescription">
                    ...
                    <div className="calendar-events" style={{ backgroundColor: "#14BEF0", color: "white" }}>Prescription</div>
                    </a>
                  </Link>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="col-5 mt-2">
                                            ...
                                            <div className="col-7">
                                                <div className="row">
                                                    <div className="col-2">
                                                        <button className='btn border' style={{ backgroundColor: "#14BEF0", color:"white" }}>Day</button>
                                                    </div>
                                                    <div className="col-2">
                                                    ...
                                                    <div className="col-6">
                                                        <button className='btn' style={{ backgroundColor: "#14BEF0", color:"white" }}> <small>Add New Appointment</small> </button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
