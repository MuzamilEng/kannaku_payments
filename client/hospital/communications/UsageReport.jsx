            ...
            <div className={`main-wrapper ${menu ? 'slide-nav' : ''}`}>
                ...
                <div className="page-wrapper">
                            ...
                            <div className="row align-items-center">
                                <div className="col">
                                    ...
                                    <ul className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item active">Usage Report</li>
                                    </ul>
                                </div>
                  ...
                  <Link href="/communications/usage-report">
                    <a>
                      <div className="calendar-events" style={{ backgroundColor: "#14BEF0", color: "white" }}>Usage Report</div>
                    </a>
                  </Link>
                                </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-6">
                                                <div className="row p-4">
                                                    ...
                                                    <div className="col-6">
                                                        <button className='btn' style={{ backgroundColor: "#14BEF0", color: "white" }}>send report</button>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            {/* <div className="row m-5 ">
                                                ...
                                                <img src="../../src/assets/img/vector.png" width="108px" height="84px" alt="" />
                                            </div> */}
                                        </div>
                                    </div>
                                </div>
