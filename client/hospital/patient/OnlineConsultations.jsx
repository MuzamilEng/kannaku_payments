...
const OnlineConsultations = (props) => {
                                ...
                                <div className="row p-5 justify-content-center align-items-center">
                                    ...
                                    <div className="col-6">
                                        <span className='user-img'>
                                            ...
                                            <img src="/src/assets/img/doctors/healthicons_doctor-male.png" alt="" />
                                        </span>
                                        <p>You do not have any consultations yet</p>
                                        <button className='btn' style={{ color: "white", backgroundColor: "#14BEF0" }}>Ask a Doctor</button>
