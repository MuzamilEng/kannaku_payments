                    ...
                    <div className="row">
                        <div className="col-12 flightbooking-body">
                            ...
                            <div className="row ms-4 pt-2 mt-5">
                                <div className="col-8">
                                    <div className="row">
                                        <div className="col-6"><h2 className="text-blue pt-2 pb-2">Delhi - Sydney</h2></div>
                                        <div className="col-6"><h2 className="text-blue pt-2 pb-2">Sydney - Delhi</h2></div>
                                        <div className="col-6">
                                            <div className="row border pt-2 pb-2" style={{backgroundColor:"lightgray"}}>
                                                <div className="col-3">Airline</div>
                                                <div className="col-3">Departure</div>
                                                <div className="col-3">Arrival</div>
